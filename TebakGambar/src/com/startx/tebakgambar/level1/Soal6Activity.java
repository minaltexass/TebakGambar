...
public class Soal6Activity extends Activity {
	EditText jawaban6;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_soal6);
		jawaban6=(EditText)findViewById(R.id.isisoal6);
		jawaban6.setFilters(new InputFilter[] { new InputFilter.AllCaps()});
	}
	public void CekJawaban6(View v){
		String jawabanbenar6 = "MOTHER BOARD";
		String jawabanbenar61 = "MOTHERBOARD";
		String jawabanuser=jawaban6.getText().toString();
		if (jawabanuser.equals(jawabanbenar6)){
			Toast.makeText(getApplicationContext(), "JAWABAN " + jawabanbenar6 + " BENAR", 
					Toast.LENGTH_LONG).show();
			Intent i = new Intent(getApplicationContext(),Soal7Activity.class);
			startActivity(i);
			finish();
		}else if (jawabanuser.equals(jawabanbenar61)){
			Toast.makeText(getApplicationContext(), "JAWABAN " + jawabanbenar61 + " BENAR", 
					Toast.LENGTH_LONG).show();
			Intent i = new Intent(getApplicationContext(),Soal7Activity.class);
			startActivity(i);
			finish();
	...
	public void jawaban_salah(){
		AlertDialog.Builder salah=new AlertDialog.Builder(Soal6Activity.this);
	...
	public void jawaban_kosong(){
		AlertDialog.Builder kosong=new AlertDialog.Builder(Soal6Activity.this);
